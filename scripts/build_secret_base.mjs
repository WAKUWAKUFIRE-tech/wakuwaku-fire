...
<html lang="ja">
  ...
  <body class="secret-base-page secret-base-public">
    ...
    <main id="main-content">
      <section class="secret-base-hero">
        <div class="secret-base-shell secret-base-hero__inner">
          <div class="secret-base-hero__copy">
            ...
            <h1>🔒 大人の秘密基地</h1>
            <p class="secret-base-hero__subtitle">ワクワクFIREコミュニティ メンバー限定エリア</p>
            <div class="secret-base-hero__lead">
              <p>ここは、ワクワクFIREコミュニティのメンバーだけが入れる秘密基地。</p>
              <p>限定資料やコミュニティで蓄積してきたコンテンツなど、一般公開していないものをまとめています。</p>
            </div>
            <p class="secret-base-hero__note">大人になっても、秘密基地はちょっとワクワクする。メンバーの方は、鍵を開けて中へどうぞ。</p>
      ...
      <section class="secret-base-community-section" aria-labelledby="secret-base-community-title">
        <div class="secret-base-shell secret-base-community-card">
          <div class="secret-base-community-card__copy">
            <p class="secret-base-eyebrow">JOIN THE COMMUNITY</p>
            <h2 id="secret-base-community-title">メンバーになって、秘密基地へ。</h2>
            <p>ワクワクFIREコミュニティのメンバーになって、限定エリア「大人の秘密基地」へ。鍵の向こうには、メンバーだけのコンテンツが待っています。</p>
          </div>
          <div class="secret-base-community-card__action">
            <a class="secret-base-button secret-base-button--gold" href="https://community.camp-fire.jp/projects/view/778625" target="_blank" rel="noopener noreferrer">CAMPFIREコミュニティに参加する <span aria-hidden="true">↗</span></a>
            <p class="secret-base-community-card__note">CAMPFIREでコミュニティの詳細を見る</p>
          </div>
        </div>
      </section>
