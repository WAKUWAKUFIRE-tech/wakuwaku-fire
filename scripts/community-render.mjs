...
<section class="community-section community-section--promo"><a class="community-shell community-promo community-promo-link" href="${CAMPFIRE}" aria-labelledby="community-promo-title" data-analytics-event="community_campfire_click" data-analytics-label="lp_image_promo" data-analytics-category="community"><div class="community-promo__visual"><img src="/FIREコミュニティ.png" alt="ワクワクFIREコミュニティで仲間と語り合うイメージ" width="1024" height="1024" loading="lazy"></div><div class="community-promo__body"><p class="community-eyebrow">WAKUWAKU FIRE COMMUNITY</p><h2 id="community-promo-title">お金も自由もワクワクも、全部話せる。</h2><p>資産形成の相談から、FIRE後の毎日や趣味の話まで。気軽に話せる仲間が集まっています。</p><span class="community-button">コミュニティに参加する ↗</span></div></a></section>
